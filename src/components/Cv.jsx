  ...
  <>
    <div className="col-md-8 offset-md-2">
      <p className="intro-text">
        I am a strong and passionate front end developer with good communication skills and a keen eye for detail. I
        work well in a team just as well as I do on my own.
      </p>
      <p>
